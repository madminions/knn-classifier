...
clear;close all;clc;
%=============================================KNN K= 1==========================================
printf('Knn classifier for BreastCancer DATA for K=1 random subsampling \n');
for iteration = 1:10
...
%=============================================KNN K = 3 =========================================
clear;
printf('Knn classifier for BreastCancer DATA for K=3 random subsampling \n');
for iteration = 1:10
	[testing_set,training_set,testing_class,training_class]=readPermute();
...
printf('Knn classifier for BreastCancer DATA for K=1 five folds cross validation \n');
clear;
for i=1:10
...
printf('Knn classifier for BreastCancer DATA for K=3 five folds cross validation \n');
clear;
for i=1:10
