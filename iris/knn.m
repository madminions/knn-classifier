...
clear;close all;clc;
%=============================================KNN K= 1===== ====================================
printf('Knn classifier for IRIS DATA for K=1 random subsampling \n');
for iteration = 1:10
	...
	for i=1:m
		if( strcmp(output_class{i,1},testing_class{i} )==1 )
			positive=positive+1;
		endif
	end
...
%=============================================KNN K = 3 =========================================
printf('Knn classifier for IRIS DATA for K=3 random subsampling \n');
clear;
for iteration = 1:10
	[testing_set,training_set,testing_class,training_class]=readPermute();
...
printf('Knn classifier for IRIS DATA for K=1 five folds cross validation \n');
clear;
for i=1:10
...
printf('Knn classifier for IRIS DATA for K=3 five folds cross validation \n');
mean_matrix
clear;
for i=1:10
